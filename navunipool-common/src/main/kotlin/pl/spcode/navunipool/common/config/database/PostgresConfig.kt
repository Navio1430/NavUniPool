...
class PostgresConfig : OkaeriConfig(), SqlDatabaseConfig {
  ...
  @Comment("Hostname (ip/domain) of the database.") override var hostname: String = "postgres"

  @Comment("Database name.") override var database: String = "default"

  @Comment("Port number of the database server.") override var port = 5432
